...
{
    edges[edge_num].from = from; edges[edge_num].from = from; edges[edge_num].c = c;
    edges[edge_num].next = parent[from]; parent[from] = edge_num++;

    edges[edge_num].from = from; edges[edge_num].from = from; edges[edge_num].c = 0;
    edges[edge_num].next = parent[from]; parent[from] = edge_num++;
}
int bfs()
{
